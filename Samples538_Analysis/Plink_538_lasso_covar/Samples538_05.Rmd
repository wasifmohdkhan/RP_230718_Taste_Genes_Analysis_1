---
title: "538 Plink analysis lasso with covariates"
...
mkdir -p /media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Samples538_Analysis/Plink_538_lasso_covar
cd /media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Samples538_Analysis/Plink_538_lasso_covar
...
# filter and lasso regression with covariates
...
# Read VCF file
vcf <- read.vcfR(here("Samples538_Analysis/Plink_538_lasso_covar/Samples538_55gene_Plink_filtered_geno.5_maf.01_hwe.001_anno.vcf"))
...
```{r}
assoc_file = read.table(here("Samples538_Analysis/Plink_538_lasso_covar/Samples538_55gene_Plink_filtered_geno.5_maf.01_hwe.001.lasso"),
                        header = T)
assoc_file
...
assoc_file_df_chromPOS_to_gene_variant_adjP_3 = assoc_file_df_chromPOS_to_gene_variant_adjP %>% 
  ...
  dplyr::select(Gene, SNP, Location_GRCh38, Effect_allele, Variant_Type,Variant_Effect) 
...
# Create a vector
column_names <- c("Gene", "SNP", "Location_GRCh38", "Effect_allele", "Variant_Type", "Variant_Effect")
# Define the width of each column
column_widths <- c(1, 1, 1.5, 0.5, 2, 1)
...
print(doc,
      target = here("Samples538_Analysis/Plink_538_lasso_covar/Samples538_55gene_Plink_filtered_geno.5_maf.01_hwe.001_lasso_w_covariates_Padj.docx"))
