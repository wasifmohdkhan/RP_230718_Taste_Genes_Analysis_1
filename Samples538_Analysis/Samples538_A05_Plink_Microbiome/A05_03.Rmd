...
Heatmap(t(heatmap_matrix),
        ...
        col = colorRamp2(c(-0.1, 0, 0.1), c("blue", "white", "red")),
        cluster_rows = TRUE,
        cluster_columns = FALSE,  # Adjust based on preference
        show_row_names = TRUE,
...
```{r}
# Drawing the heatmap with adjusted legend positions
ht = Heatmap(heatmap_matrix,
        name = "EFFECT",
        left_annotation   = variant_type_annotation,
        col = colorRamp2(c(-0.1, 0, 0.1), c("blue", "white", "red")),
        cluster_rows = TRUE,
        ...
        show_row_dend = FALSE,
        column_title = "Gene_Location",
        row_title = "Feature")  # Position main heatmap legend
