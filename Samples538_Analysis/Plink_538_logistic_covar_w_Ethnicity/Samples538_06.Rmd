...
--covar-name Age,Sex,SEFI_score,Indigenous,Asian,Latin,African,Mixed,Caucasian \
--allow-no-sex \
...
# Read VCF file
vcf <- read.vcfR(here("Samples538_Analysis/Plink_538_logistic_covar_w_Ethnicity/Samples538_55gene_Plink_filtered_geno.5_maf.01_hwe.001_anno.vcf"))
