...
# Run the function in parallel for all *.bam files
ls *_aligned.bam     | parallel -j 10 process_stats_CollectWgsMetrics
...
```{bash}
conda activate GATK_env
cd /media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/CHRIM_80_Analysis/CHRIM_80_genes_35/CHRIM_80_35_GATK/BQSR_dedup_bamqc
