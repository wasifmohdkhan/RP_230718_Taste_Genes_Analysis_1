...
mkdir -p ./Fastqc_report/MultiQC_report
/home/wasif_pclab/anaconda3/envs/multiqc/bin/multiqc \
--interactive --force \
./Fastqc_report \
-o ./Fastqc_report/MultiQC_report
```
...
mkdir -p ./Aligned_bamqc/samtools_stats/MultiQC_report

process_qualimap_bamqc() {
...
export -f process_qualimap_bamqc
# Run the function in parallel for all *.bam files
ls *_aligned.bam     | parallel -j 40 process_qualimap_bamqc

/home/wasif_pclab/anaconda3/envs/multiqc/bin/multiqc \
--interactive --force \
./Aligned_bamqc/samtools_stats \
-o ./Aligned_bamqc/samtools_stats/MultiQC_report
```
...
```{bash}
 cd /media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/CHRIM_80_Analysis/CHRIM_80_genes_35/CHRIM_80_35_GATK
  ...
  rm ./Aligned_bamqc/samtools_stats/*_aligned_bam.stats
```
...
# Function for processing each file
process_picard_CollectWgsMetrics() {
  file=$1
  SAMPLE_NAME=$(echo $1 | sed -e 's/_aligned.bam//')
  
  _JAVA_OPTIONS="-Xmx90g" picard SortSam \
      I=${SAMPLE_NAME}_aligned.bam \
...
export -f process_picard_CollectWgsMetrics

# Run the function in parallel for all *.bam files
ls *_aligned.bam  | parallel -j 20 process_picard_CollectWgsMetrics
```
