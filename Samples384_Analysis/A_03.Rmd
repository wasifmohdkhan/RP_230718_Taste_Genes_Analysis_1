...
write.table(Phenotype,
     here("Samples384_Analysis/VCFtoPLINK/Samples379_Combined_Phenotype.txt"),
     col.names = F,
     row.names = F,
     quote = F,
     sep = "\t")
...
write.table(Phenotype_with_sex_info,
     here("Samples384_Analysis/VCFtoPLINK/Samples379_Combined_Phenotype_with_sex_info.txt"),
     col.names = F,
     row.names = F,
     quote = F,
     sep = "\t")
