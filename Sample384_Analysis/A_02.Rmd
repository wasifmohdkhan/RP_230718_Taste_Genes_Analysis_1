...
# Output directory
OUT_DIR=/media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384
...
```{bash}
cd ~/media_Second_stor_wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384
mkdir FastqToGVCF
```


```{bash}
cd ~/media_Second_stor_wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384/FastqToGVCF
...
# Output directory
OUT_DIR=/media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384/FastqToGVCF/
...
process_files() {
    ...
    OUTPUT_name=/media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384/FastqToGVCF/${SAMPLE_NAME}_FastqToSam.bam
    picard FastqToSam \
        FASTQ=$R1 \
        FASTQ2=$R2 \
        OUTPUT=$OUTPUT_name \
...
process_SamToFastq_bwa_MergeBamAlignment() {
  ...
  TMP=~/media_Second_stor_wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384
  # Number of cores
  THREADS=4
...
cd ~/media_Second_stor_wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384/FastqToGVCF
mkdir ~/media_Second_stor_wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384/FastqToGVCF/VCF
# Function for processing each file
process_gatk_HaplotypeCaller() {
  ...
  -L /media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/bed_files/Merged_bed_hg38_Jan15_no_names.bed
}
...
```{bash}
cd ~/media_Second_stor_wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/GATK_BS384/FastqToGVCF/VCF
...
cmd+= " -L /media/Second_stor/wasif/WK_Rprojects/RP_230718_Taste_Genes_Analysis_1/Sample384_Analysis/GATK_pipepile/bed_files/Merged_bed_hg38_Jan15_no_names.bed"
